...
- 权重文件：`public/champion_final.net`（770KB，小模型；按项目约定明确提交到 `deeplearning-model`，不进入框架仓库 `deeplearning`）
...
- Manifest: `https://alphazero-gomoku-model.011203.workers.dev/model.json`
- Weights: `https://alphazero-gomoku-model.011203.workers.dev/champion_final.net`
